...
#Config
#right now this assumes that there is an existing S3 bucket that has an IAM policy allowing your configured user to upload to the bucket
# just using a subset of the images right now
ROOT_DIRECTORY = './data/images/species_validate/acinonyx_jubatus' 
BUCKET_NAME = 'from-camera-trap'
VALIDATION_METATA = './data/obs_and_meta/processed/felids_validation.csv'
